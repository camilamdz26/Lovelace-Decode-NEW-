...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -1919.5505707155207; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -1227.9965062078277; // x position of the perpendicular encoder (in tick units)
    }
